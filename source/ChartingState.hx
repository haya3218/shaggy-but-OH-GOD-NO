...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var m_check2 = new FlxUICheckBox(60, 45, null, null, "12", 100);
	...
	override function update(elapsed:Float)
	{
		...
		if (_song.mania == 2 && gridBG.width != S_GRID_SIZE * 24)
		{
			remove(gridBG);
		...
		if (_song.mania == 2) strumLine.x = 10;
		else strumLine.x = 0;
